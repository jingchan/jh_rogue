...
xcopy /S classes-jre classes-examples >devnull
javac -source 1.3 -target 1.3 -classpath classes-examples gamegen/*.java tutorial/*.java examples/*.java examples/nebulaalpha/*.java examples/waterworld/*.java examples/matrixminer/*.java examples/packetstorm/*.java examples/guardian/*.java examples/ogrotron/*.java examples/dingbats/*.java -d classes-examples
