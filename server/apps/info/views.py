...
def markdown(request):
    return shortcuts.render_to_response('info/markdown.html',  {},  context_instance = RequestContext(request))

def reputation(request):
    return shortcuts.render_to_response('info/reputation.html',  {},  context_instance = RequestContext(request))

def htmltags(request):
    return shortcuts.render_to_response('info/htmltags.html',  {},  context_instance = RequestContext(request))